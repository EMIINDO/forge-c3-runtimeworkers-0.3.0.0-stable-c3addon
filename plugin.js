...

{
	...
	////////////////////////////////////////////
	const PLUGIN_ID = "Massive_Cube_Forge";
	////////////////////////////////////////////
...
const PLUGIN_CLASS = SDK.Plugins.Massive_Cube_Forge = class ForgePlugin extends SDK.IPluginBase
	{
		constructor()
		{
			super(PLUGIN_ID);
			...
			this._info.AddFileDependency({
				filename: "c3runtime/forge.min-custom.js",
				type: "inline-script"
			});
